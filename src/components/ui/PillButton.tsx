...
export default function PillButton({ label, href, onClick, cursorLabel }: PillButtonProps) {
  ...
  const body = (
    <span className="pointer-events-none relative z-[1] flex items-center gap-3">
  ...
  const shared =
    'geology-pill group relative inline-flex items-center overflow-hidden rounded-full border border-bone/10 bg-bone/[0.05] py-1.5 pl-1.5 pr-2 ' +
    'transition-colors duration-300 ease-out-expo hover:border-bone/25 hover:bg-bone/[0.09]'
