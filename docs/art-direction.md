...
- **Display** — `Oswald` 500, конденсированные **КАПСЫ**, трекинг `+0.02em`
  (утилита `.display-title`). Характер гравировки на монументе. Все заголовки —
  только этим голосом, без исключений.
...
Утилиты: `.display-title`, `.font-display`, `.font-mono-t`, `.eyebrow`.
